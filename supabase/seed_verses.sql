...
(3, 3, '여호수아 1장 8절', '이 율법책을 네 입에서 떠나지 말게 하며 다 지켜 행하라 그리하면 네가 형통하리라', '이 율법책을 떠나지 말게 하라', 'https://www.youtube.com/watch?v=qUewsTFzdzg&list=PLmW-GwY4IF3yRWzP8gEPtAUvKqNeVstCf&index=23'),
...
(6, 6, '사도행전 16장 31절', '주 예수를 믿으라 그리하면 너와 네 집이 구원을 받으리라', '주 예수를 믿으라', 'https://www.youtube.com/watch?v=O6NmpvcYyD8&list=PLmW-GwY4IF3y3e8moiN6bS-AwhAzzwyya&index=36'),
...
(8, 8, '누가복음 4장 8절', '주 너의 하나님께 경배하고 다만 그를 섬기라', '광야의 세 가지 질문', 'https://www.youtube.com/watch?v=vRQzw_vTYxw&list=PLmW-GwY4IF3yRWzP8gEPtAUvKqNeVstCf&index=19'),
