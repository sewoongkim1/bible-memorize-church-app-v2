...
FONT_PT = 9.2
BIGO_LINES = 4        # 사역팀 소개서 비고 줄 — 칸은 쪽 끝까지 늘고, 줄은 그 안에 고르게 벌어진다
#                       (문의처 줄을 더하며 5 → 4: 줄이 칸보다 많으면 flex 가 못 눌러 넘친다)
...
# 작성자·필요 인원·「시간(문장)」 둘째 줄·「하는 일」 둘째·셋째 줄은 자료에 없어 성도님이 예시로 정해 주셨다(2026-09-17).
