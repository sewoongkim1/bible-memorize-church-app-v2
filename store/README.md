...
- 개인정보처리방침 URL: `https://gocheok.onlybible.kr/` (앱 안 ❓ → 자세한 안내에 있음)

### 6. 앱 콘텐츠 (심사에서 자주 막히는 곳)
- **데이터 보안 양식**: 이 앱은 **이름·소속과 암송 기록**을 수집한다.
  비밀번호·연락처·결제정보는 받지 않는다(필사 신청만 휴대폰 번호).
  「수집함 → 개인정보(이름) / 앱 활동」으로 신고하고, 전송 시 암호화(HTTPS) 체크.
