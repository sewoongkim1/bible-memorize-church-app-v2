...
- [ ] 앨범 이어 듣기(v3.183~184) 실기기 확인: ⏭⏮가 한 칸씩만 움직이는지 · 「요약 함께」에서 낭독과 MP3가 겹치지 않는지(`_ttsGen` 가드) · 고르기 칩을 눌러도 화면이 위로 튀지 않는지 · 아이폰에서 화면을 껐을 때 MP3만 이어지는지
