...
- [ ] 이어 듣기(v3.183~186) 실기기 확인: 말씀 목록·앨범 두 화면 · ⏭⏮가 한 칸씩만 움직이는지 · 「요약 함께」에서 낭독과 MP3가 겹치지 않는지(`_ttsGen` 가드) · 고르기 칩을 눌러도 화면이 위로 튀지 않는지 · 아이폰에서 화면을 껐을 때 MP3만 이어지는지
- [ ] 사탕 카드 실물 시험 인쇄: 배율·잉크 번짐·QR 스캔·재단선(#8f9cb0) 진하기
