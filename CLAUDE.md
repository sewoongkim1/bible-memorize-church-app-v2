...
- [ ] **사역신청(2026) — 담당자 데이터 확정 대기(개발 착수 전)**: 종이 「사역신청서」를
      ...
      **개발보다 데이터 확정이 먼저**다. 그 확인용 엑셀 양식(`tools/ministry-form-gen.py`
      → `ministry/2026_사역신청_부서확인양식.xlsx`, 94팀·2026-09-07 찬양부 확정 반영)은
      ...
      **2026-09-07 — 앱이 열리기 전까지는 올해도 종이로 받는다**(성도님 확정:
      ...
      `tools/ministry-apply-form-gen.py` → `ministry/2026_사역신청서_A4.pdf`로
      만들었다 — `ministry_catalog_2026_draft.json`을 그대로 읽으므로 팀명이
      ...
      **2026-09-07 — 찬양부·전도부 첫 확인 결과 반영**: 성도님이 찬양부 세부
      ...
      확정해 `ministry_catalog_2026_draft.json`·확인 양식·종이 신청서 세 곳에
