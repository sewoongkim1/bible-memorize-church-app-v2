...
""" + blk('✍️', '암송하기: 빈칸 채우며 외우기', '틀려도 괜찮아요', ol([
    ...
    '<b>3단계</b> — 전부 빈칸',
    '맞으면 <b>초록색</b>, 틀리면 잠깐 <b>빨간색</b>. 막히면 <b>💡 힌트</b>가 한 글자씩 보여 줍니다.',
])) + """
<div class="two">
""" + blk('🔊', '귀로 듣기', '', ol([
    '구절 옆 <b>🔊</b> — 그 말씀 하나',
...
""" + blk('✍️', '성경필사 노트 신청', '한 분 5부까지', ol([
    '첫 화면 <b>✍️ 성경필사 노트 신청</b> — 노트 크기·필사 유형·번역본을 고르고 원하는 성경을 담으세요.',
    '휴대폰 번호를 남기시면 준비되는 대로 알려 드립니다. 주일 <b>4층 새가족실</b>에서 받으세요(<b>권당 3,000원</b>).',
])) + """
</div>
<div class="foot">
