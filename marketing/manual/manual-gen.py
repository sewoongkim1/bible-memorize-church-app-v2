...
NAVY = '#123059'
# 흑백 복사나 토너가 약한 프린터에서도 보이도록 기존 금색보다 한 단계 진하게.
GOLD = '#765700'
...
/* QR이 안 찍힐 때 손으로 쳐야 하는 글자다 — 가장 작아서는 안 된다 */
.h-url { font-size:10pt; font-weight:700; color:%(navy)s; margin-top:1.2mm; letter-spacing:-.2pt; }
...
/* 위가 비어 있으니 마지막 안내는 넉넉히 — 어르신이 가장 자주 되돌아볼 두 줄이다 */
.tail-note { font-size:13pt; line-height:2.05; color:#333; text-align:center;
             word-break:keep-all; margin-bottom:4.5mm; }
...
# ── 앞면: 시작하기 ─────────────────────────────────────────────
FRONT = head('', '성경말씀 암송 앱 시작하기') + """
<div class="lead">
  휴대폰으로 <b>말씀을 외우는 앱</b>입니다. 별도의 가입이나 비밀번호가 없습니다.<br>
  아래 <b>①②③</b>을 한 번만 해 두시면, 다음부터는 바탕화면의 앱 아이콘만 누르시면 됩니다.
</div>
<div class="blocks">
""" + blk('①', '앱 열기', '30초', ol([
    '오른쪽 위 <b>QR 코드</b>에 휴대폰 카메라를 비추세요.',
    '화면에 나타난 <b>링크를 누르면</b> 앱이 열립니다.',
    'QR이 안 되면 인터넷 주소창에 <b>gocheok.onlybible.kr</b>을 입력하세요.',
])) + blk('②', '바탕화면에 앱 만들기', '1분', """
  <p style="margin-bottom:2mm"><b>카카오톡 안에서는 설치와 음성 기능이 제한됩니다.</b>
     먼저 「Safari로 열기」 또는 「다른 브라우저로 열기」를 누르세요.</p>""" + ol([
    '앱 첫 화면 위쪽 <b>📲(홈 화면에 추가)</b>를 누르세요.',
    '<b>안드로이드</b> — 「설치」를 누르세요. 창이 안 뜨면 오른쪽 위 <b>⋮ → 「앱 설치」</b>.',
    '<b>아이폰</b> — Safari의 공유 단추(네모에 ↑)를 누르고, 목록을 아래로 넘겨 '
    '<b>「홈 화면에 추가」 → 「추가」</b>.',
    '바탕화면에 <b>「성경암송」 아이콘(교회 로고)</b>이 생기면 성공입니다.',
...
<div class="tail"><div class="foot">뒷면에 <b>앱 사용 설명서</b>가 있습니다 &nbsp;▶</div></div>"""

# ── 뒷면: 쓰는 법 ─────────────────────────────────────────────
BACK = head('', '성경말씀 암송 앱 사용 방법', qr=False) + """
<div class="blocks">
""" + blk('✍️', '암송하기: 빈칸 채우며 외우기', '틀려도 괜찮아요', ol([
    '첫 화면에서 <b>「📖 암송하기」</b>를 누르고 외울 말씀을 고르세요.',
    '<b>1단계</b>(빈칸 조금) → <b>2단계</b>(빈칸 많이) → <b>3단계</b>(전부 빈칸)',
    '맞으면 <b>초록색</b>, 틀리면 잠깐 <b>빨간색</b>이 됩니다.',
    '막히면 <b>💡 힌트</b> — 한 글자씩 보여 줍니다.',
])) + """
<div class="two">
""" + blk('🔊', '귀로 듣기', '', ol([
    '구절 옆 <b>🔊</b> — 그 말씀 하나',
...
<div class="two">
""" + blk('👑', '외운 말씀 모으기', '', ol([
    '3단계에서 끝까지 외운 뒤 <b>👑 마음에 두었나이다</b>',
    '<b>📖 나의 말씀 앨범</b>에 모여요',
    '가리고 스스로 맞혀 볼 수 있어요',
])) + blk('🏆', '함께하기', '', ol([
    '<b>🏆 순위</b> — <b>👏</b>로 서로 응원해요',
    '<b>💬 응원·기도·공감</b> — 응원 글과 기도 제목을 나눠요',
])) + """
</div>
<div class="two">
""" + blk('💬', '내게 주시는 말씀', '', ol([
    '첫 화면 <b>💬</b>를 누르세요',
    '궁금한 것을 물어보세요',
    '<b>목사님 설교 내용을 바탕으로</b> 답해 드려요',
])) + blk('🌿', '매일 묵상', '', ol([
    '첫 화면 <b>🌿</b>를 누르세요',
    '그 주 설교를 <b>요일마다 한 조각씩</b>',
    '짧아서 아침에 읽기 좋아요',
])) + """
</div>
""" + blk('✍️', '성경필사 노트 신청', '',
      '<p>첫 화면 <b>「✍️ 성경필사 노트 신청」</b>에서 손으로 말씀을 쓰며 묵상할 노트를 신청할 수 있어요.</p>') + """
</div>
<div class="tail">
  <div class="tail-note">
...
html = ('<!doctype html><html lang="ko"><head><meta charset="utf-8">'
        '<title>성경말씀 암송 앱 사용 설명서</title><style>' + STYLE + '</style></head><body>'
